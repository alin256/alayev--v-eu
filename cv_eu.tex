\documentclass[utf8, a4paper, nologo, noflag, 11pt, helvetica, narrow, booktabs, totpages, english]{europecv}
...
\input{python/reports}

%TODO include track reccord for NFR
\input{track-reccord}
